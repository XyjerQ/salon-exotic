      ...
      <section className="bg-white rounded-xl shadow-md p-6">
        <div className="flex flex-wrap justify-between items-start gap-4 mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={loadData} className="bg-gray-100 hover:bg-gray-200 px-4 py-2 rounded-lg text-sm font-medium">Refresh</button>
          </div>
        </div>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4 space-y-3">
          <div className="grid md:grid-cols-5 gap-3">
            ...
            {/* Dodany wyraźny nagłówek SEARCH nad polem wyszukiwania */}
            <div className="md:col-span-5">
              <label className="block text-xs font-semibolda tracking-wider text-gray-600 mb-1">
                Search
              </label>
              <input 
                type="text" 
