...
export default function CarList({ cars, employees = [], isAdmin, onEdit, onDelete, onAdd, loading, onViewHistory }) {
    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="grid gap-6">
          {cars.map(car => (
            <div key={car.id} className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm transition-shadow hover:shadow-xl">
                  ...
                  {car.primary_image ? (
                    ...
                    <div className="flex h-full min-h-64 flex-col justify-between p-6 text-white">
                      <div className="flex gap-2">
                        {car.featured && <span className="rounded-full bg-yellow-300 px-3 py-1 text-xs font-semibold text-black">Featured</span>}
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    <div>
                      <div className="mb-2 flex flex-wrap gap-2">
                        {car.featured && <span className="rounded-full bg-yellow-100 px-3 py-1 text-xs font-semibold text-yellow-800">Featured</span>}
