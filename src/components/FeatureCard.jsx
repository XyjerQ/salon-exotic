...
export default function FeatureCard({ title, desc, image, year, horsepower, mileage, onViewDetails }) {
  return (
    ...
    >
      ...
      <div className="p-2 md:p-3 mt-2 md:mt-3 flex-1 flex flex-col">
        ...
        <div className="mt-3">
          <button
            className="w-full bg-blackline-accent text-black py-2 rounded-md font-medium hover:opacity-90"
