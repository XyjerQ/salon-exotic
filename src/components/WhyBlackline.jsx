...
const items = [
  ...
  },
  {
    ...
    desc: 'Home delivery, registration, and insurance handled for you end-to-end.',
  },
  {
    ...
    <section className="bg-blackline-surface text-white py-10 md:py-14">
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          {items.map((item) => (
            <div key={item.title} className="border border-white/10 rounded-lg p-6 bg-white/5 text-center flex flex-col items-center gap-4">
